...
### training
parser.add_argument("--data_path", help="training data path", default="/run/media/tkwoo/myWorkspace/workspace/01.dataset/kaggle/cat_dog")
parser.add_argument("--total_epoch", help="number of epochs", default=200, type=int)
parser.add_argument("--initial_learning_rate", help="init lr", default=0.01, type=float)
parser.add_argument("--learning_rate_decay_factor", help="learning rate decay", default=0.5, type=float)
parser.add_argument("--epoch_per_decay", help="lr decay period", default=10, type=int)
